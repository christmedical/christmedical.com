...
- **Branch:** `main` (after this commit); local checkout may be on `develop` until synced
- **Latest tag:** `v0.2.1`
...
- **Last commit hash and date:** `99c94c0b3ea19013d3f0a31ddd3d3a7de8864844` — 2026-05-13 (squash merge of PR #14 to `main`)
