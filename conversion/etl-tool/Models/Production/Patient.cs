...
public class Patient
{
    ...
    /// <summary>Mission / tenant identifier (SMALLINT in PostgreSQL).</summary>
    ...
    /// <summary>Date from legacy <c>heardgospel</c> when available.</summary>
    public DateTime? HeardGospelDate { get; set; }

    /// <summary>Combined spiritual check-up notes (church, personal, hope, info).</summary>
