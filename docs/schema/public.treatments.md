...
| general_notes | text |  | true |  |  |  |
| id | uuid | gen_random_uuid() | false | [public.prescriptions](public.prescriptions.md) [public.procedure_details](public.procedure_details.md) |  |  |
| is_deleted | boolean | false | true |  |  |  |
| is_flagged | boolean | false | true |  |  |  |
| provider_name | varchar(255) |  | true |  |  |  |
...
| ---- | ---- | ---------- |
| treatments_pkey | PRIMARY KEY | PRIMARY KEY (id) |
| treatments_visit_id_fkey | FOREIGN KEY | FOREIGN KEY (visit_id) REFERENCES visits(id) |

## Indexes

| Name | Definition |
| ---- | ---------- |
| treatments_pkey | CREATE UNIQUE INDEX treatments_pkey ON public.treatments USING btree (id) |
