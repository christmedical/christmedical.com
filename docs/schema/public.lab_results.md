...
| ---- | ---- | ---------- |
| lab_results_pkey | PRIMARY KEY | PRIMARY KEY (id) |
| lab_results_visit_id_fkey | FOREIGN KEY | FOREIGN KEY (visit_id) REFERENCES visits(id) |

## Indexes

| Name | Definition |
| ---- | ---------- |
| lab_results_pkey | CREATE UNIQUE INDEX lab_results_pkey ON public.lab_results USING btree (id) |
